...
public struct ObjCCompat {
    ...
    open class Subscription: NSObject {
         ...
         */
        @objc open func addSubscribeHandler(_ handler: @escaping SubscribeHandler) -> Subscription {
        ...
        /**
         ...
         - returns: The same subscription, for easy chaining.
         */
        @objc open func addUnsubscribeHandler(_ handler: @escaping SubscribeHandler) -> Subscription {
        ...
        /**
         ...
         - returns: The same subscription, for easy chaining.
         */
        @objc open func addErrorHandler(_ handler: @escaping ErrorHandler) -> Subscription {
        ...
        /**
         ...
         - returns: The same subscription, for easy chaining.
         */
        @objc open func addEventHandler(_ handler: @escaping EventHandler) -> Subscription {
        ...
        /**
         ...
         - returns: The same subscription, for easy chaining.
         */
        @objc open func addLeaveHandler(_ handler: @escaping ObjectHandler) -> Subscription {
        ...
        /**
         ...
         - returns: The same subscription, for easy chaining.
         */
        @objc open func addCreateHandler(_ handler: @escaping  ObjectHandler) -> Subscription {
        ...
        /**
         ...
         - returns: The same subscription, for easy chaining.
         */
        @objc open func addUpdateHandler(_ handler: @escaping  ObjectHandler) -> Subscription {
        ...
        /**
         ...
         - returns: The same subscription, for easy chaining.
         */
        @objc open func addDeleteHandler(_ handler: @escaping  ObjectHandler) -> Subscription {
